...
def main() -> None:
    ...
    macros: list[tuple[str, str]] = [
        ...
        ("SFItsCompEffectTwelveM", latex_float(float(sf_comp["effect_at_horizon"]), digits=3, signed=True)),
        ...
        ("SFItsStanceEffectTwelveM", latex_float(float(sf_stance["effect_at_horizon"]), digits=3, signed=True)),
        ...
        ("SFItsKeywordsEffectTwelveM", latex_float(float(sf_keywords["effect_at_horizon"]), digits=3, signed=True)),
        ...
        ("AlItsCompEffectTwelveM", latex_float(float(al_comp["effect_at_horizon"]), digits=3, signed=True)),
        ...
        ("AlItsStanceEffectTwelveM", latex_float(float(al_stance["effect_at_horizon"]), digits=3, signed=True)),
        ...
        ("AlItsKeywordsEffectTwelveM", latex_float(float(al_keywords["effect_at_horizon"]), digits=3, signed=True)),
