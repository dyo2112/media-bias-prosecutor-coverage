...
- **Source ecology drives structural differences.** Progressive prosecutor coverage draws on 2.3× more advocacy group sources, 1.4× more expert sources, and 1.5× more politician quotes — the empirical fingerprint of institutional mobilization ("toplash").
